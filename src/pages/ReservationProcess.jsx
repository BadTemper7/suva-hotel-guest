                            ...
                            >
                              <div className="flex items-center justify-between mb-3">
                                ...
                                <button
                                  ...
                                  className="h-9 w-9 rounded-lg border border-gray-200 bg-white hover:bg-gray-50 grid place-items-center text-[#0c2bfc] transition-all duration-200"
                                >
                                  <FiTrash2 size={14} />
                                </button>
                              </div>
                              <div className="space-y-3">
                                <div className="flex items-center justify-between">
                                  ...
                                  <button
                                    ...
                                    className="h-8 px-3 rounded-lg bg-[#0c2bfc] hover:bg-[#0a24d6] text-white text-xs font-medium inline-flex items-center gap-1 transition-all duration-200"
                                  >
                                  ...
                                  (amenity, amenityIndex) => {
                                    ...
                                    return (
                                      <div
                                        ...
                                        className="grid gap-3 sm:grid-cols-12 items-center rounded-lg border border-gray-200 bg-white p-3"
                                      >
                                        <div className="sm:col-span-7">
                                          ...
                                          <select
                                            ...
                                            className="mt-1 w-full h-9 rounded-lg border border-gray-200 bg-white px-3 text-sm outline-none focus:ring-2 focus:ring-[#0c2bfc]/20 focus:border-[#0c2bfc] text-gray-700"
                                          >
                                            {amenities.map((a) => (
                                ...
                                {roomRes.amenities.length === 0 && (
                                  <div className="text-xs text-gray-500 italic text-center py-3 border border-dashed border-gray-200 rounded-lg bg-gray-50">
